...
# ---------------------------------------------------------------
video_path = f"{YOWO_HOME}/datasets/AVA/video_done/9Y_l9NsnYE0.mp4"
# base_output = f"{YOWO_HOME}/output"
...
out = cv2.VideoWriter(f"{YOWO_HOME}/outputs/{name}_processed.{extension}", cv2.VideoWriter_fourcc('M','J','P','G'), fps, (frame_width,frame_height))
